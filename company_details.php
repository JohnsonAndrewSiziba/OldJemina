				...
				<div class="row">
					<div class="col-md-8">
						...
						<div class="content row">
							...
							<div>
								<br />
								<table id="company_details" class="display" width="100%"></table>
							</div>
							...
							<div class="panel panel-default">
								<div class="panel-heading" role="tab" id="ques-i1">
									<h3 class="panel-title">
										<a class=" color-primary" role="button" data-toggle="collapse" data-parent="#general" href="#ques-ans-i1" aria-expanded="false">
											TOP SHAREHOLDERS
					...
					<!-- Sidebar -->
				    <?php include_once("companies_sidebar.php"); ?>
					<!-- Sidebar #end -->
				</div>
...
<div id="myModal" class="modal">
	...
	<script src="<?php echo $site ?>price_sheet/dataScript.js"></script>
</body>
</html>