...
class PriceSheetSummary{
    ...
    fetchAndDisplay(){
        fetch(this.api_base + 'api/price_sheet/summary/' + this.id).then(function (response) {
            return response.json();
        }).then(function (data) {
...
class StockChart{
    ...
    fetchAndDisplay(){
        ...
        // Load data
        chart.dataSource.url = this.api_base + "api/historic_data/" + this.id;
