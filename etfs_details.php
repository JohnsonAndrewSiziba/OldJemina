					...
					<div class="col-md-8">
						...
						<div class="content row">
							...
							<h3 class="color-primary">
								TOP COUNTERS AS AT 
								<small>
									<span id="counter_date"></span>
								</small>
							</h3>
							<div>
								<br />
								<table style="font-size: 12px;" id="company_details" class="display" width="100%"></table>
							</div>
...
<div id="myModal" class="modal">
	...
	<script src="<?php echo $site ?>price_sheet/etfsScript.js"></script>
